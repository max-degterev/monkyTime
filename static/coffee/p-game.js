...
(function() {
  (function($) {
    var Entity, Player, api, block, btoa, engine, game, highscore, leadZeros, log, md5, music, options, scoreboard, screens, win;
    if (!Date.now) {
      Date.now = function() {
        return +new Date();
      };
      ...
      handleKeys = function(e) {
        switch (e.keyCode) {
          case 27:
            return togglePause();
          case 37:
            return game.player.move(-options.player.step, true);
          case 39:
            return game.player.move(options.player.step, true);
        }
      };
      handleMouse = function(e) {
        return game.player.move(e.pageX - game.player.x - game.player.width / 2 - game.offset.x);
      };
      gameOver = function() {
        stopEngine();
